...
\033[1;97m   ╙─╜╙──╜╙─╜╙────╜╙────╜
\033[1;97m--------------------------------------------------
\033[1;93m(!)\033[1;97m Author   : Kiss
\033[1;93m(!)\033[1;97m Github   : https://github.com/idunil1
\033[1;93m(!)\033[1;97m Fb          : https://www.facebook.com/Idunil.Sampath2003
...
def choice_select():
	...
	print(50*"-")
	print("[!] The process has completed")
	print("[!] Total I-S OK/I-S CP :"+str(len(oks)))+"/"+str(len(cps))
	raw_input("[!] Press enter to back")
	choose()
